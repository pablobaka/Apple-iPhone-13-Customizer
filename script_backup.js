$(document).ready(function(){
   ...
   $(".btn-color-selector").click(function(){
      ...
      //    }  
         ...
         //          break;
         //       case ('chalk-pink'):
         //          $(".div-case-img").css("background-image", "url('/img/img-case/13-mini-chalk-pink.png')");
         //          break;
         //       case ('abyss-blue'):
         //          $(".div-case-img").css("background-image", "url('/img/img-case/13-mini-abyss-blue.png')");
         //          break;
         //       case ('pink-pomelo'):
         //          $(".div-case-img").css("background-image", "url('/img/img-case/13-mini-pink-pomelo.png')");
         //          break;
         //       case ('midnight'):
         //          $(".div-case-img").css("background-image", "url('/img/img-case/13-mini-midnight.png')");
         //          break;
         //       case ('blue-jay'):
         //          $(".div-case-img").css("background-image", "url('/img/img-case/13-mini-blue-jay.png')");
         //          break;
         //    }
         // }
         // else if (currentPhoneModel == "13") {
         //    switch(currentElement.attr('id')) {
         //       case ('marigold'):
         //          $(".div-case-img").css("background-image", "url('/img/img-case/13-marigold.png')");
         //          break;
         //    }
         // }
